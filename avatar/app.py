...
# First assistant bubble on load (no API call). Override with WELCOME_MESSAGE in .env if you like.
WELCOME_MESSAGE = os.getenv(
    "WELCOME_MESSAGE",
    f"Hi — I'm **{AGENT_NAME}**. Ask me about my background, skills, or experience, "
    "or say what you're looking for and we'll go from there.",
)
...
# Module-level Blocks so the app can be imported (e.g. by the playground launcher).
